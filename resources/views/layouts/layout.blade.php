  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-dark sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="#">
        ...
        <div class="sidebar-brand-text mx-2">Perpustakaan Anjayyyy</div>
      </a>
      ...
      <div id="content">
          ...
          <form class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
            <div class="input-group">              
              <div class="input-group-append">  
                <h4> Perpustakaan Berbasis Web </h4>          
              </div>
            </div>
          </form>
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Sistem Peminjaman dan Pengembalian Buku</h1>
          </div><hr>
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
              <h5>Dashbord</h5>
          </div>
      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>Create By: Kelompok 2<br>Copyright &copy; Kelompok 2 2020</span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
